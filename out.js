...
define("fillers", ["require", "exports", "lib", "maps", "sizers"], function (require, exports, lib_js_2, maps, sizers) {
    ...
    var verify = function (filler) { return function (layer, config, canvas) {
        ...
        if (mapFn === undefined) {
            throw "Undefined map - ".concat(map, ", the maps are ").concat(Object.keys(maps).join(', '));
        }
        else if (sizeFn === undefined) {
            throw "Undefined sizer - ".concat(size, ", the sizers are ").concat(Object.keys(sizers).join(', '));
        }
        else {
    ...
    var layer = function (canvas, parentConfig, grid) {
        var config = __assign(__assign({}, parentConfig), { width: toNumber(canvas.getAttribute("width"), parentConfig.width), height: toNumber(canvas.getAttribute("height"), parentConfig.height), x: toNumber((canvas.getAttribute("x") || "0px"), parentConfig.width) + (parentConfig.x || 0), y: toNumber((canvas.getAttribute("y") || "0px"), parentConfig.height) + (parentConfig.y || 0) });
...
define("00/flare", ["require", "exports", "../engine.js", "utils", "maps", "processors"], function (require, exports, engine_js_3, utils_js_3, maps_3, processors_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("00/lare", ["require", "exports", "../engine.js", "utils", "maps", "processors"], function (require, exports, engine_js_4, utils_js_4, maps_4, processors_js_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.lare = void 0;
    var colors = ['green', 'blue', 'yellow'];
